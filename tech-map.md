...
| 기술 | salary | pong | mz | amlife | food | tarot | psycho-bot | telbot | collab-tool | product-j | error-auto | human2 | dictionary | rackops | hexalounge | hexaconsulting | tok-wrapped | tok-iq | vibejob | poli | whisper | wp-mcp | love | ideal | quit-calc | infra-quote | saju |
|------|:------:|:----:|:--:|:------:|:----:|:-----:|:----------:|:------:|:-----------:|:---------:|:----------:|:------:|:----------:|:-------:|:----------:|:-------------:|:-----------:|:------:|:-------:|:----:|:-------:|:-------:|:----:|:-----:|:---------:|:-----------:|:----:|
| **프론트엔드** | | | | | | | | | | | | | | | | | | | | | | | | | | | |
| Tailwind CDN | ✅ | | | | | | | | | | | | | | ✅ | ✅ | | | |  | | | | | ✅ | | |
| Tailwind v3 빌드 | | | | | ✅ | | | | | | | | | ✅ | | | | | |  | | | | | | | |
